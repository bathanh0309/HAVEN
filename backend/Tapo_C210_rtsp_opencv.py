...
ip_address = '10.0.14.14' # Replace with the IP address of your camera
port = '8090'          # Replace with the port number for your camera
username = 'bathanh0309'    # Replace with the username for your camera
password = 'bathanh0309' # Replace with the password for your camera
